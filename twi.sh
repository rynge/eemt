...
saga_cmd -f=q --cores=1 ta_morphometry 0 -ELEVATION $DEM_GRID.sgrd -SLOPE slope_grid_rad -ASPECT aspect_grid_rad
...
saga_cmd -f=q --cores=1 ta_hydrology 1 -ELEVATION $DEM_GRID.sgrd -CAREA catchment_grid -METHOD 2

# Run SAGA Wetness Index http://www.saga-gis.org/saga_module_doc/2.1.3/ta_hydrology_15.html
saga_cmd -f=q --cores=1 ta_hydrology 15 -DEM $DEM_GRID.sgrd -SLOPE slope_grid_rad.sgrd -AREA catchment_grid.sgrd -TWI twi_grid

# Export Files as GeoTiffs
saga_cmd -f=q --cores=1 io_gdal 2 -GRIDS slope_grid_rad.sgrd -FILE slope_rad.tif
saga_cmd -f=q --cores=1 io_gdal 2 -GRIDS aspect_grid_rad.sgrd -FILE aspect_rad.tif
...
saga_cmd -f=q --cores=1 io_gdal 2 -GRIDS catchment_grid.sgrd -FILE catchment.tif

saga_cmd -f=q --cores=1 io_gdal 2 -GRIDS twi_grid.sgrd -FILE twi.tif
