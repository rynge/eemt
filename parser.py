...
class TiffParser(object):
	...
	#Warp DEM to opentopoo

	#command = ['gdalwarp', '-overwrite', '-t_srs',"+proj=lcc +lat_1=25 +lat_2=60 +lat_0=42.5 +lon_0=-100 +x_0=0 +y_0=0 +datum=WGS84 +units=m +no_defs",'-r', 'cubic', '-of', 'GTiff', '-tr', '10', '-10', '-dstnodata','None']
        dem_file=tiff
	command = 'gdalwarp -overwrite -t_srs "+proj=lcc +lat_1=25 +lat_2=60 +lat_0=42.5 +lon_0=-100 +x_0=0 +y_0=0 +datum=WGS84 +units=m +no_defs" -r bilinear -of GTiff -tr 10 10 -dstnodata nan '
